...
const products = [
  {
    id: 1,
    name: "Triple Wavelength Diode Laser Machine",
    description: "The gold standard for hair reduction for clinics. Medical-grade Diode laser machine supplier offering competitive wholesale pricing in India and UAE.",
    ...
    benefits: "High-ROI equipment for aesthetic clinics, fast treatment times, and safe for all Fitzpatrick skin types. Perfect for busy dermatology practices.",
    image: img1,
    alt: "Professional Triple Wavelength Diode Laser Machine for permanent hair removal"
  },
  {
    id: 2,
    ...
    image: img2,
    alt: "Q-Switched Nd:YAG Laser equipment for tattoo removal and carbon peel treatments"
  },
  {
    id: 3,
    ...
    image: img3,
    alt: "B2B IPL Machine supplier for skin rejuvenation and acne therapy"
  },
  {
    id: 4,
    ...
    image: img4,
    alt: "Medical grade Fractional CO2 Laser machine for acne scar resurfacing"
  },
  {
    id: 5,
    ...
    image: img5,
    alt: "Professional RF Microneedling device for skin tightening and scar revision"
  },
  {
    id: 6,
    ...
    image: img6,
    alt: "4D 7D HIFU machine for non-surgical face lifting and skin tightening"
  },
  {
    id: 7,
    ...
    image: img7,
    alt: "360 degree Cryolipolysis fat freezing machine for body sculpting clinics"
  },
  {
    id: 8,
    ...
    image: img8,
    alt: "Ultrasonic Cavitation and RF system for cellulite reduction and body contouring"
  },
  {
    id: 9,
    ...
    image: img9,
    alt: "Medical Blue Light LED therapy system for active acne management"
  },
  {
    id: 10,
    ...
    image: img10,
    alt: "LLLT Cold Laser machine for hair regrowth and scalp health"
  },
  {
    id: 15,
    name: "Pico Laser Machine",
    description: "Advanced Pico laser technology for high-speed tattoo removal and skin pigmentation treatment. Competitive Pico laser machine price for bulk orders.",
    howItWorks: "Pico laser technology uses ultra-short pulses (one trillionth of a second) to shatter pigment into tiny dust-like particles. This allows for faster results with less heat and greater safety for the skin compared to traditional nanosecond lasers.",
    benefits: "Faster treatment cycles, superior results for stubborn pigments, and high patient satisfaction rates for clinic owners.",
    image: img2, // Reusing existing assets or replace with specific Pico image
    alt: "Advanced Pico Laser machine for pigment removal and skin rejuvenation"
  },
  {
    id: 11,
    name: "HIFU Machine for Clinics (4D/7D)",
    description: "High-Intensity Focused Ultrasound for non-surgical lifting. Leading HIFU machine supplier for clinics looking for professional-grade skin tightening solutions.",
    ...
    image: img11,
    alt: "Professional HIFU machine for clinical aesthetic treatments"
  },
  {
    id: 12,
    ...
    image: img12,
    alt: "Dedicated RF Radio Frequency system for face and body skin tightening"
  },
  {
    id: 13,
    ...
    image: img13,
    alt: "Long pulse Nd:YAG laser for spider vein and vascular lesion treatment"
  },
  {
    id: 14,
    ...
    image: img14,
    alt: "Hydrafacial Alice Bubble 7-in-1 aqua peel machine for deep cleansing"
  }
];
